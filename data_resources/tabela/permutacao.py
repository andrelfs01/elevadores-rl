...
for row in df.iterrows():
    ...
    new_row = {'id': row['id'], 'from': row['from'], 'to': row['to'], 'car': row['car'], 'incoming_time': row['incoming_time'], 'boarding_time': row['boarding_time'],
                ...
                'dist_d_deny2': row['dist_d_deny2'],
                'n_call_deny2': row['n_call_deny2'],
                'n_floor_deny2': row['n_floor_deny2'],
                'car_position_deny2': row['car_position_deny2'],
                'car_direction_deny2': row['car_direction_deny2'],
                'car_queue_buttons_deny2': row['car_queue_buttons_deny2'],
                'car_queue_floor_deny2': row['car_queue_floor_deny2'],
